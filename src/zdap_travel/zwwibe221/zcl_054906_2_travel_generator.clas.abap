CLASS zcl_054906_2_travel_generator DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC.
...
CLASS ZCL_054906_2_TRAVEL_GENERATOR IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.

    "Datenobjekte deklarieren
    DATA travel TYPE z054906_2_travel.
    DATA travels TYPE TABLE OF z054906_2_travel.

    DATA booking TYPE z054906_2_book.
    DATA bookings TYPE TABLE OF z054906_2_book.

    "Alle Daten der Datenbanktabellen löschen
    DELETE FROM z054906_2_travel.
    out->write( |deleteted travels: {  sy-dbcnt }| ).
    DELETE FROM z054906_2_book.
    ...
    INSERT z054906_2_travel FROM TABLE @travels.
    out->write( |inserted travels: {  sy-dbcnt }| ).
    INSERT z054906_2_book FROM TABLE @bookings.
