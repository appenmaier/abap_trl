...
CLASS lhc_zi_dap_booking IMPLEMENTATION.
  ...
  METHOD cancel_booking.
    ...
    DATA message TYPE REF TO zcm_dap_booking.
    ...
    LOOP AT bookings INTO booking.
      ...
      IF booking-Status = 'X'.
        message = NEW zcm_dap_booking( severity = if_abap_behv_message=>severity-error
                                       booking_id = booking-BookingId
                                       textid = zcm_dap_booking=>already_cancelled ).
